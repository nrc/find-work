...
class App extends React.Component {
    ...
    render() {
      ...
      if (this.state.data) {
        body = (<Switch>
          <Route exact path='/' render={routeProps => <Tabs {...routeProps} tabs={this.state.data.tabs}/>} />
          <Route exact path='/:tab/:category' render={routeProps => <Tabs {...routeProps} tabs={this.state.data.tabs}/>} />
          <Route exact path='/:tab' render={routeProps => <Tabs {...routeProps} tabs={this.state.data.tabs}/>} />
        </Switch>);
      } else {
