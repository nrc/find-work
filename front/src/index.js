  ...
  return (
    <BrowserRouter basename="/findwork">
      <div>
        ...
        <Switch>
          <Route exact path='/' render={routeProps => <Tabs {...routeProps} />} />
          <Route exact path='/:tab/:category' render={routeProps => <Tabs {...routeProps} />} />
          <Route exact path='/:tab' render={routeProps => <Tabs {...routeProps} />} />
        </Switch>
